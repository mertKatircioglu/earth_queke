...
import 'package:sismy/widgets/home.dart';
    ...
    if(emailController.text.isNotEmpty && passwordController.text.isNotEmpty){
      ...
      await authUser.signInWithEmailAndPassword(email: emailController.text.trim(),
        ...
        if(currentUser != null){
          ...
          showDialog(context: context, builder: (c){
            return CustomErrorDialog(message:"Kullanıcı Bulunamadı.");
          });
      ...
      showDialog(context: context, builder: (c){
        return CustomErrorDialog(message: "Lütfen Tüm Alanları Doldurun.",);
      });
    }
  }
    ...
    return Scaffold(
      body:  Container(
        ...
        child: Column(
          ...
          children: [
            const Text("Kayıt Ol", style:TextStyle(color:Colors.black45,fontSize: 28, fontWeight: FontWeight.w600, shadows: [
              Shadow(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children:  const [
                Text("Şifreni mi unuttun? ", style:TextStyle(color: Colors.black45)),
                Text("Buraya tıkla.", style:TextStyle(color: Colors.blueAccent),)
              ],
            )
          ],
        ),
